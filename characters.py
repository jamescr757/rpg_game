...
# The Cobra evades attacks 50% of the time and has lethal venom 10% of the time 
class Cobra(Character):
    def __init__(self, health=8, power=10, bounty=8, agility=2):
...
class Goblin(Character):
    def __init__(self, health=6, power=3, bounty=5, agility=2):
        super().__init__("Goblin", health, power, bounty, agility)

# The Medic can recover 2 health points 20% of the time 
...
class Shadow(Character):
    def __init__(self, health=1, power=3, bounty=7, agility=10):
